  ...
  return (
    ...
    >
      <div className={styles.navbar}>
        <a href="https://madhuri-portfolio-lac.vercel.app/">
          <div className={styles.logo}>
            <img
              src="https://user-images.githubusercontent.com/75351991/189522031-ea3926d0-6043-435e-b13a-75fc7727574e.png?raw=true"
              alt="Logo"
            />
          </div>
        </a>
