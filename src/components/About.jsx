...
import resume from "../media/MadhuriResume.pdf";
import transcript from "../media/MadhuriResume.pdf";
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    <p style={{ fontSize: "17px", fontWeight: "500" }}>
                      ...
                      kinds of people with different thinkings.In spare time I
                      like Dancing,MotivationBooks read and travelling. Gaining
                      skills by which I can create something productive.
                      Currently looking for an job opportunity to work in an
                      interesting company by applying my skills.
                    </p>
                  </Card.Text>
            ...
            <Col lg={4} align="center">
              <Card className="nbcard">
                <Card.Body>
                  ...
                  <div>
                    <p>
                      Madhuri Patel <br /> At.Post-Ait Lucknow UP.
                      <br />{" "}
                      <strong style={{ fontWeight: "600" }}>7355244164</strong>
                      <br />
